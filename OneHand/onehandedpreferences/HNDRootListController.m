#include "HNDRootListController.h"

@implementation HNDRootListController
...
- (void)reportBug {
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://github.com/Hax0rDoge/OneHand/issues"]];
}

@end

@implementation HNDCreditsListController
